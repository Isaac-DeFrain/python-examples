...
## epoch 42
dt42_start = datetime.strptime('2022-12-01T18:00:00Z', '%Y-%m-%dT%H:%M:%SZ')
dt42_end = datetime.strptime('2022-12-16T14:59:59Z', '%Y-%m-%dT%H:%M:%SZ')

## epoch 43
dt43_start = datetime.strptime('2022-12-16T15:00:00Z', '%Y-%m-%dT%H:%M:%SZ')
dt43_end = datetime.strptime('2022-12-31T11:59:59Z', '%Y-%m-%dT%H:%M:%SZ')
...
# Convert the timestamp to ticks
